...
const animals5=function ({navigation}){
  ...
  return sound
    ...
    return <View >   
               ...
               <View style={style.styleView456}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/animals/monkey.mp3'))}}> 
                                    <View  style={style.styleView}>
                                        
                                        <View style={style.styleView888}>
                                            <View style={style.styleView8882}>
                                                <Image style={style.imageVio888} source={require('../../../assets/animals/monkey.png')}/>
                                                <Text style={{marginTop:100, marginHorizontal:10 , fontSize:20, fontWeight:"bold"}}>MONKEY</Text>
                                            </View>
                        ...
                        <View style={style.styleView}>
                            ...
                            <View style={style.styleView78}>
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/animals/goat.mp3'));navigation.pop();navigation.navigate('Animals4')}}> 
