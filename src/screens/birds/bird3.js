...
const bird3=function ({navigation}){
  ...
  return sound
    ...
    return <View >   
               ...
               <View style={style.styleView456}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/birds/parrot.mp3'))}}> 
                                            <View  style={style.styleView}>
                                                
                                                <View style={style.styleView888}>
                                                    <View style={style.styleView8882}>
                                                        <Image style={style.imageVio888} source={require('../../../assets/birds/parrot.png')}/>
                                                        <Text style={{marginTop:100, marginHorizontal:10 , fontSize:20, fontWeight:"bold"}}>PARROT</Text>
                                                    </View>
                        ...
                        <View style={style.styleView}>
                            ...
                            <View style={style.styleView78}>
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/birds/peacock.mp3'));navigation.pop();navigation.navigate('Bird2')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/birds/duck.mp3'));navigation.pop();navigation.navigate('Bird4')}}> 
