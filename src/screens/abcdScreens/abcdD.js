...
const abcdD=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/d.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >D</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/dog.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/dog.png')}/>            
                    </TouchableOpacity>
               
            </View>

            <View style={style.styleView4}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/duck.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/duck.png')}/>          
                    </TouchableOpacity>
