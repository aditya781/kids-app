...
const abcdE=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/e.mp3'))}}> 
                                    <View style={style.styleView}>
                                        <Text style={style.textStyle} >E</Text>
                                    </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/egg.mp3'))}}> 
                                <Image style={style.imageVio} source={require('../../../assets/abcd/egg.png')}/>            
                        </TouchableOpacity> 
                
            </View>

            <View style={style.styleView4}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/elephant.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/elephant.png')}/>              
                    </TouchableOpacity> 
                         ...
                         <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/d.mp3'));navigation.pop();navigation.navigate('AbcdD')}}> 
