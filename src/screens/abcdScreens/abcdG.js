...
const abcdG=function ({navigation}){
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/g.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >G</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/goat.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/goat.png')}/>     
                    </TouchableOpacity> 
               
            </View>
            <View style={style.styleView4}>

                        <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/grapes.mp3'))}}> 
                            <Image style={style.imageVio1} source={require('../../../assets/abcd/grapes.png')}/> 
                        </TouchableOpacity> 
                         ...
                         <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/f.mp3'));navigation.pop();navigation.navigate('AbcdF')}}> 
