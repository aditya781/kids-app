...
const abcdK=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/k.mp3'))}}> 
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/key.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/key.png')}/>              
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/kangaroo.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/kangaroo.png')}/>            
                    </TouchableOpacity> 
