...
const abcdF=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/f.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >F</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/frog.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/frog.png')}/>        
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/fish.mp3'))}}> 
                            <Image style={style.imageVio1} source={require('../../../assets/abcd/fish.png')}/>      
                    </TouchableOpacity> 
                         ...
                         <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/e.mp3'));navigation.pop();navigation.navigate('AbcdE')}}> 
