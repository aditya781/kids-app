...
const abcdM=function ({navigation}){
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/m.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >M</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/monkey.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/monkey.png')}/>             
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/mouse.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/mouse.png')}/>        
                    </TouchableOpacity> 
                         ...
                         <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/l.mp3'));navigation.pop();navigation.navigate('AbcdL')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/n.mp3'));navigation.pop();navigation.navigate('AbcdN')}}> 
