...
const abcdO=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/o.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >O</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/owl.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/owl.png')}/>         
                    </TouchableOpacity>
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/octopus.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/octopus.png')}/>      
                    </TouchableOpacity>
                       ...
                       <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/n.mp3'));navigation.pop();navigation.navigate('AbcdN')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/p.mp3'));navigation.pop();navigation.navigate('AbcdP')}}> 
