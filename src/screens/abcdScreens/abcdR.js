...
const abcdR=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/r.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >R</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/rose.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/rose.png')}/>       
                    </TouchableOpacity>
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/rocket.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/rocket.png')}/>          
                    </TouchableOpacity>
                        ...
                        <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/q.mp3'));navigation.pop();navigation.navigate('AbcdQ')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/s.mp3'));navigation.pop();navigation.navigate('AbcdS')}}> 
