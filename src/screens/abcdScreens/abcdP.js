...
const abcdP=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/p.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >P</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/pig.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/pig.png')}/>      
                    </TouchableOpacity> 
               
            </View>
            <View style={style.styleView4}>

                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/parrot.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/parrot.png')}/>      
                    </TouchableOpacity> 
                         ...
                         <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/o.mp3'));navigation.pop();navigation.navigate('AbcdO')}}> 
