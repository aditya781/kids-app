...
const abcdW=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/w.mp3'))}}> 
                    <View style={style.styleView}>
                        <Text style={style.textStyle} >W</Text>
                    </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/well.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/well.png')}/>          
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/watermelon.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/watermelon.png')}/>          
                    </TouchableOpacity> 
                        ...
                        <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/v.mp3'));navigation.pop();navigation.navigate('AbcdV')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/x.mp3'));navigation.pop();navigation.navigate('AbcdX')}}> 
