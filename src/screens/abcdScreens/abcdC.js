...
const abcdC=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/c.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >C</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/cat.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/cat.png')}/>             
                    </TouchableOpacity> 
                
            </View>

            <View style={style.styleView4}>
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/cake.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/cake.png')}/>             
                    </TouchableOpacity> 
