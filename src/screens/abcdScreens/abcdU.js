...
const abcdU=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/u.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >U</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/umbrella.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/umbrella.png')}/>        
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/uniform.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/uniform.png')}/>         
                    </TouchableOpacity> 
                         ...
                         <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/t.mp3'));navigation.pop();navigation.navigate('AbcdT')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/v.mp3'));navigation.pop();navigation.navigate('AbcdV')}}> 
