...
const abcdT=function ({navigation}){
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/t.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >T</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/truck.mp3'))}}> 
                         <Image style={style.imageVio} source={require('../../../assets/abcd/truck.png')}/>        
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/tiger.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/tiger.png')}/>          
                    </TouchableOpacity> 
