...
const abcdI=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/i.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >I</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/iceCream.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/iceCream.png')}/>         
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/iron.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/iron.png')}/>        
                    </TouchableOpacity> 
                        ...
                        <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/h.mp3'));navigation.pop();navigation.navigate('AbcdH')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/j.mp3'));navigation.pop();navigation.navigate('AbcdJ')}}> 
