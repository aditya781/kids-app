...
const abcdY=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/y.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >Y</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/yak.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/yak.png')}/>           
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/yolk.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/yolk.png')}/>       
                    </TouchableOpacity> 
