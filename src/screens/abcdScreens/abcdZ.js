...
const abcdZ=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/z.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >Z</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/zoo.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/zoo.png')}/>         
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/zebra.mp3'))}}> 
                            <Image style={style.imageVio1} source={require('../../../assets/abcd/zebra.png')}/>         
                    </TouchableOpacity> 
                       ...
                       <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/y.mp3'));navigation.pop();navigation.navigate('AbcdY')}}> 
