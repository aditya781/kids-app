...
const abcdJ =function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/j.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >J</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/joker.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/joker.png')}/>     
                    </TouchableOpacity> 
                
            </View>
            <View style={style.styleView4}>

                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/juice.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/juice.png')}/>        
                    </TouchableOpacity> 
