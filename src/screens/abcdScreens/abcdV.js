...
const abcdV=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/v.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >V</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/violin.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/violin.png')}/>        
                    </TouchableOpacity> 
            ...
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/volcano.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/volcano.png')}/>     
                    </TouchableOpacity> 
                       ...
                       <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/u.mp3'));navigation.pop();navigation.navigate('AbcdU')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/w.mp3'));navigation.pop();navigation.navigate('AbcdW')}}> 
