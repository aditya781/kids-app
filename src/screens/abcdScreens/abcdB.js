...
import { StyleSheet, Text, View,  Image, TouchableOpacity, BackHandler,Dimensions } from 'react-native';
...
const abcdB=function ({navigation}){
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                    ...
                    <View style={style.styleView1}>
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/b.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >B</Text>
                            </View>  
                        </TouchableOpacity>
                        ...
                        <View style={style.styleView3}>
                            <View style={style.styleView4}>
                                    ...
                                    <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/for/ball.mp3'))}}> 
                                        <Image style={style.imageVio} source={require('../../../assets/abcd/ball.png')}/>              
                                    </TouchableOpacity> 
                            </View>

                            <View style={style.styleView4}>
                                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/boy.mp3'))}}> 
                                        <Image style={style.imageVio1} source={require('../../../assets/abcd/boy.png')}/>          
                                    </TouchableOpacity> 
                    ...
                    {/*start buttonCom */}
                        <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/a.mp3'));navigation.pop();navigation.navigate('AbcdA')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/c.mp3'));navigation.pop();navigation.navigate('AbcdC')}}> 
