...
const abcdX=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/x.mp3'))}}> 
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/xray.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/xray.png')}/>         
                    </TouchableOpacity> 
                
            </View>
            <View style={style.styleView4}>

                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/xmasTree.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/xmasTree.png')}/>  
                    </TouchableOpacity> 
