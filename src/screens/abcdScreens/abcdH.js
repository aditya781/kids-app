...
const abcdH=function ({navigation}){
  ...
  return sound
    ...
    return <View >
                ...
                <View style={style.styleView33}>
                        ...
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/h.mp3'))}}> 
                            <View style={style.styleView}>
                                <Text style={style.textStyle} >H</Text>
                            </View>
        ...
        <View style={style.styleView3}>
            <View style={style.styleView4}>
                    ...
                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/house.mp3'))}}> 
                        <Image style={style.imageVio} source={require('../../../assets/abcd/house.png')}/>         
                    </TouchableOpacity> 
                
            </View>
            <View style={style.styleView4}>

                    <TouchableOpacity style={{}} activeOpacity={0.8} onPress={()=>{playSound(require('../../../assets/audios/for/hat.mp3'))}}> 
                        <Image style={style.imageVio1} source={require('../../../assets/abcd/hat.png')}/>        
                    </TouchableOpacity> 
                       ...
                       <View style={style.styleView78}>
                            <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/g.mp3'));navigation.pop();navigation.navigate('AbcdG')}}> 
                                ...
                                <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../../assets/audios/abcd/i.mp3'));navigation.pop();navigation.navigate('AbcdI')}}> 
