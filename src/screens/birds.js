...
const birds=function ({navigation}){
  ...
  return sound
    ...
    return <View >   
                ...
                <View  style={style.styleView456}>
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../assets/audios/birds/hen.mp3'))}}> 
                                    <View  style={style.styleView}>
                                        <BirdCom image={require('../../assets/birds/hen.png')} name="HEN "/>
                                    </View>
                        </TouchableOpacity>
