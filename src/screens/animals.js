...
const animals=function ({navigation}){
    ...
    return <View >   
               ...
               <View style={style.styleView3377}>
                ...
                <View  style={style.styleView456}>
                        <TouchableOpacity style={{}} activeOpacity={0.8}  onPress={()=>{playSound(require('../../assets/audios/animals/horse.mp3'))}}> 
                                            <View  style={style.styleView}>
                                                
                                                <View style={style.styleView888}>
                                                    <View style={style.styleView8882}>
                                                        <Image style={style.imageVio888} source={require('../../assets/animals/horse.png')}/>
                                                        <Text style={{marginTop:100, marginHorizontal:100 , fontSize:20, fontWeight:"bold"}}>HORSE</Text>
                                                    </View>
